...
1. **Load agent context**: read root `AGENTS.md`. If an `AGENTS.md` exists under a path relevant to the request, read it. Skim agent-oriented comments and code near the affected area.
