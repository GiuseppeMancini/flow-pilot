...
description: >-
  ...
  cross-links, and cleanup. Use during exploration and whenever you touch a
  file—add or refresh comments so the next session can navigate faster. Also use
  when the user asks for agent-oriented comments, handoff notes in code,
  “comments for AI”, or to fix stale or noisy comments. Read this skill before
  bulk-commenting or refactoring documentation in source.
---
...
- **Every file you change**: before finishing, scan the touched symbols—update comments that became wrong, add what a newcomer would need, delete noise.
